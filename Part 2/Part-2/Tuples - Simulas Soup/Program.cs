// Define enumeration for different  food: Soup, stew, gumbo
// Define enumeration for main ingrediant: Mushrooms, chicken, carrots, potatoes
// Enum for seasoning: spicy, salty, sweet


// variable for the soup
(SoupType type, MainIngredient ingredient, Seasoning seasoning) soup = GetSoup();
Console.WriteLine($"Your {soup.seasoning}, {soup.ingredient} {soup.type} is ready");
